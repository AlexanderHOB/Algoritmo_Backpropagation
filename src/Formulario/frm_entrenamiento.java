...
public class frm_entrenamiento extends javax.swing.JFrame {
    ...
    private void btnEntrenarActionPerformed(java.awt.event.ActionEvent evt) {                                            
         IniciarGrafico();
   ...
   private void IniciarGrafico(){
    ...
    private void cbDelimitadoActionPerformed(java.awt.event.ActionEvent evt) {                                             
         if(cbDelimitado.getSelectedItem()==","){
            delimitador = ",";       
        }else if(cbDelimitado.getSelectedItem()==";"){                      
            delimitador = ";";                       
    ...
    private void niNCFocusLost(java.awt.event.FocusEvent evt) {                               

    }                              

    private void niNCMouseReleased(java.awt.event.MouseEvent evt) {                                   

    }                                  

    private void niNCFocusGained(java.awt.event.FocusEvent evt) {                                 

    }                                

    private void txtCargarActionPerformed(java.awt.event.ActionEvent evt) {                                          
        // TODO add your handling code here:
    }                                         

    private void txtCargarFocusLost(java.awt.event.FocusEvent evt) {                                    
        // TODO add your handling code here:
    }                                   

    private void niNCKeyPressed(java.awt.event.KeyEvent evt) {                                
        // TODO add your handling code here:
    }                               

    private void btnEstablecerActionPerformed(java.awt.event.ActionEvent evt) {                                              
    ...
    private void btnEstablecerMouseClicked(java.awt.event.MouseEvent evt) {                                           
    ...
    private void btnProbarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProbarActionPerformed
        frm_prueba abrirForm = new frm_prueba(){
            ...
            public void dispose(){
                ...
                super.dispose();
                //Hacemos visible la principal
                frm_entramiento.setVisible(true);
